  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-5 left-2 z-50 bg-emerald-600 hover:bg-emerald-700 text-white p-2 rounded-lg 
      ...
      >
        {/* Header */}
        <div className="p-6 font-bold text-lg border-b border-emerald-200 dark:border-gray-700 ">
          Task Manager
        </div>
