  ...
  return (
    <div className="sidebar ">
      ...
      <button
        ...
        className=" left-2 z-50 bg-emerald-600 hover:bg-emerald-700 text-white p-2 m-3 rounded-lg 
      ...
      <aside
        ref={sidebarRef}
        className={`fixed top-0 left-0 min-h-full w-52 bg-emerald-100 dark:bg-gray-900 text-gray-900
